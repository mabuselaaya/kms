...
<title>HlamvanaSkillsAcademy</title>
...
<div class="wrapper">
	...
	<div class="right-section">
		<h1 id="logo">HlamvanaSkillsAcademy</h1>
		<div class="seprator"></div>
		<div class="main-content">
			<h2>Our Web Application is coming soon</h2>
			<p></p>
		</div>
		<ul class="social">
			<li id="facebook"><a href="https://www.facebook.com/HlamvanaSkillsAcademy"><i class="fa fa-facebook"></i></a></li>
			<li id="twitter"><a href="https://twitter.com/HlamvanaSkillsAcademy"><i class="fa fa-twitter"></i></a></li>
			<li id="instagram"><a href="https://www.instagram.com/HlamvanaSkillsAcademy/"><i class="fa fa-Instagram"></i></a></li>
		</ul>
		<ul class="info">
			<li><i class="fa fa-phone-square"></i>(079) 840 7847</li>
			<li><i class="fa fa-map-marker"></i>Gauteng, South Africa</li>
			<li><i class="fa fa-envelope"></i><a href="mailto:HlamvanaSkillsAcademy@gmail.com"> HlamvanaSkillsAcademy@gmail.com</a></li>
		</ul>
